// Package mimetypelookup provides a Go client for the MIME Type Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/mimetypelookup?utm_source=go&utm_medium=readme
package mimetypelookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/mimetypelookup"
	defaultTimeout = 30 * time.Second
)

// Client is the MIME Type Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new MIME Type Lookup API client.
...
// Execute makes a request to the MIME Type Lookup API with typed parameters.
//
...
//   - extension (required): string - File extension to lookup (without the leading dot)
