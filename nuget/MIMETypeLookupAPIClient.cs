...
namespace APIVerve.API.MIMETypeLookup
{
    ...
    /// <summary>
    /// Client for the MIMETypeLookup API
    /// </summary>
    public class MIMETypeLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/mimetypelookup";
        ...
        {
            { "extension", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public MIMETypeLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MIMETypeLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MIMETypeLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MIMETypeLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MIMETypeLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(MIMETypeLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MIMETypeLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MIMETypeLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MIMETypeLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MIMETypeLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MIMETypeLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MIMETypeLookupQueryOptions options)
        {
