...
{
    class MIMETypeLookupExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/mimetypelookup";

        /// <summary>
        /// Make a GET request to the MIME Type Lookup API
        /// </summary>
        static async Task<JsonDocument> CallMIMETypeLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;extension&quot;] &#x3D; &quot;pdf&quot;, [&quot;mimetype&quot;] &#x3D; &quot;application/pdf&quot; };
        ...
        {
            Console.WriteLine("📤 Calling MIME Type Lookup API...\n");

            var result = await CallMIMETypeLookupAPI();
