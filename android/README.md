...
```gradle
dependencies {
    implementation 'com.github.apiverve:mimetypelookup-api:1.1.12'
}
```
...
```java
import com.apiverve.mimetypelookup.MIMETypeLookupAPIClient;
import com.apiverve.mimetypelookup.APIResponse;
import com.apiverve.mimetypelookup.APIException;

// Initialize the client
MIMETypeLookupAPIClient client = new MIMETypeLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/mimetypelookup](https://docs.apiverve.com/ref/mimetypelookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/mimetypelookup](https://docs.apiverve.com/ref/mimetypelookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/mimetypelookup-api/issues)
